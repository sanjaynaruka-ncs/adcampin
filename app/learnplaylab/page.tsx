export default function LearnPlayLab() {
  return (
    <>
      ...
      {/* ISOLATED FOOTER (outside layout wrapper to avoid duplication) */}
      <div className="bg-black border-t border-white/10 py-10">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400 px-6">
